...
class CategoryController extends Controller
{
    ...
    public function addAction(Request $request){
        ...
        if($form->isSubmitted()){
            if($form->isValid()){
                ...
                $status = "La categoria no se ha creado por que el formulario no es valido !!";
            }
    ...
    public function editAction(Request $request,$id){
        ...
        if($form->isSubmitted()){
            if($form->isValid()){
                ...
                $status = "La categoria no se ha editado por que el formulario no es valido !!";
            }
    ...
    public function categoryAction($id,$page = 0){
